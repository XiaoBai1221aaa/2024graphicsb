    ...
    glPushMatrix();
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                ...
                drawlower();///drawhand(); ///glutSolidTeapot( 0.3 );
            glPopMatrix();
        glPopMatrix();
    glPopMatrix();
    glutSwapBuffers();
...
int main(int argc, char* argv[])
{
    ...
    ///glutTimerFunc(0,timer,0);///計時器,0ms(0秒後),會呼叫
    ///glutTimerFunc(1000,timer,1);///計時器,1000ms(1秒後),會呼叫
    ///glutTimerFunc(2000,timer,2);///計時器,2000ms(2秒後),會呼叫
    ///glutTimerFunc(3000,timer,3);///計時器,3000ms(3秒後),會呼叫
    ///glutTimerFunc(5000,timer,5);///計時器,5000ms(5秒後),會呼叫
    ///glutTimerFunc(9000,timer,9);///計時器,9000ms(9秒後),會呼叫
